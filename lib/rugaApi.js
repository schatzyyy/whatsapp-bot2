...
const yt = async (url) => new Promise((resolve, reject) => {
	axios.get(`https://api.i-tech.id/dl/yt?key=&link=${url}`)
	.then((res) = {
...
const igis = async (url) => new Promise((resolve, reject) => {
	axios.get(`https://api.i-tech.id/dl/igdl?key=fs5nZj-gkwbOg-rpX8rB-tKcRAJ-RAZ9cS&link=${url`)
	.then((res) => {
		resolve(res.data)
		})
		.catch((err) =>{
...
const fb = async (url) => new Promise((resolve, reject) => {
	axios.get(`https://api.i-tech.id/dl/fb?key=fs5nZj-gkwbOg-rpX8rB-tKcRAJ-RAZ9cS&link=${url}`)
	.then((res) => {
...
const ssweb = async (apa) => new Promise((resolve,reject) => {
	axios.get(`https://api.i-tech.id/tools/ssweb?key=fs5nZj-gkwbOg-rpX8rB-tKcRAJ-RAZ9cS&link=${apa}`)
	.then((res) = {
		resolve(res.data.result)
		})
		.catch((err) => {
