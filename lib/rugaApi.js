...
const igis = async (url) => new Promise((resolve, reject) => {
	axios.get(`https://api.i-tech.id/dl/igdl?key=qTOfqt-6mDbIq-8lJHaR-Q09mTR-D6pAtD&link=${url}`)
	.then((res) => {
		resolve(res.data)
		})
		.catch((err) =>{
...
const fb = async (url) => new Promise((resolve, reject) => {
	axios.get(`https://api.i-tech.id/dl/fb?key=qTOfqt-6mDbIq-8lJHaR-Q09mTR-D6pAtD&link=${url}`)
	.then((res) => {
...
const ssweb = async (apa) => new Promise((resolve,reject) => {
	axios.get(`https://api.i-tech.id/tools/ssweb?key=qTOfqt-6mDbIq-8lJHaR-Q09mTR-D6pAtD&link=${apa}`)
	.then((res) = {
		resolve(res.data.result)
		})
		.catch((err) => {
