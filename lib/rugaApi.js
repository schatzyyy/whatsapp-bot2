...
const nowm2 = async (url) => new Promise((resolve, reject) => {
	axios.get(`https://docs-jojo.herokuapp.com/api/tiktok_nowm?url=${url}`)
	.then(res => {
	resolve(res.data)
})
.catch(err => {
...
const filmapik = async (url) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://arugaz.my.id/api/media/filmapik/search?query=${url}`)
...
const ymp4 = async (url) => new Promise((resolve, reject) => {
    axios.get(`http://arugaz.my.id/api/media/ytvid?url=${url}`)
    .then((res) => {
		resolve(res.data)
    })
    .catch((err) =>{
...
const chord = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://api.vhtear.com/chordguitar?query=${url}&apikey=${vhtearkey}`)
    .then((res) => {
		if (res.data.error) resolve(res.data.error)
        resolve(res.data.result)
    })
...
const lirik = async (judul) => new Promise((resolve, reject) => {
	axios.get(`https://api.vhtear.com/liriklagu?query=${judul}&apikey=${vhtearkey}`)
	.then((res) => {
		resolve(res.data.result)
	})
	.catch((err) => {
